...
vocab_path = r"E:\Pycharm_projects_zjy\2-testsum\bert_seq2seq-master\bert-base-chinese\vocab.txt"  # roberta模型字典的位置
word2idx = load_chinese_base_vocab(vocab_path, simplfied=False)
model_name = "bert"  # 选择模型名字
model_path = r"E:\Pycharm_projects_zjy\2-testsum\bert_seq2seq-master\bert-base-chinese\pytorch_model.bin"  # 模型位置
model_save_path = r"E:\Pycharm_projects_zjy\2-testsum\bert_seq2seq-master\state_dict\bert_title_model.bin"
batch_size = 4
lr = 1e-5
maxlen=256
...
class Trainer:
    def __init__(self):
        # 加载数据
        src_dir = r'E:\Pycharm_projects_zjy\2-testsum\bert_seq2seq-master\data_little\train_content.txt'
        tgt_dir = r'E:\Pycharm_projects_zjy\2-testsum\bert_seq2seq-master\data_little\train_summ.txt'
