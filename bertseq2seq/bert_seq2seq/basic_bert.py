...
from trainsum.bertseq2seq.bert_seq2seq.model.bert_model import BertConfig, BertModel, BertLayerNorm, BertPredictionHeadTransform, BertLMPredictionHead, CLS
...
class BasicBert(nn.Module):
    def __init__(self, word2ix, model_name="bert", tokenizer=None):
        ...
        self.config = BertConfig(vocab_size=len(word2ix))
